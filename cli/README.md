...
```
bonsol -k ./keypair.json -u http://localhost:8899 deploy s3 --bucket bonsol-public-images --region us-east-1 --access-key {your key} --secret-key {your secret key} -m program/manifest.json
```
