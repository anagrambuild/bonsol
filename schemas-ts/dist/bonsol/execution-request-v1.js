...
const execution_input_type_js_1 = require("../bonsol/execution-input-type.js");
class ExecutionRequestV1 {
    ...
    static addInputType(builder, inputType) {
        builder.addFieldInt8(4, inputType, execution_input_type_js_1.ExecutionInputType.URL);
    }
    ...
    static createExecutionRequestV1(builder, executionIdOffset, imageIdOffset, callbackProgramIdOffset, callbackInstructionPrefixOffset, inputType, inputDataOffset) {
