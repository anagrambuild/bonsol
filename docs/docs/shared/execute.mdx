...
```json
{
  ...
  "tip": 100,
  "maxBlockHeight": 100, // can also override with --expires-from-now flag
  "inputs": [
    {
      "inputType": "Public",
      "data": "0x1234567890"
...
```
The json schema for the execution request is hosted [here](https://github.com/anagrambuild/bonsol/blob/main/schemas/execution_request_v1.schema.json).
