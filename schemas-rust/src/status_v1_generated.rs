...
impl<'a> StatusV1<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.output_digest {
            builder.add_output_digest(x);
        }
...
impl<'a: 'b, 'b> StatusV1Builder<'a, 'b> {
    ...
    #[inline]
    pub fn add_output_digest(
        &mut self,
        output_digest: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u8>>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            StatusV1::VT_OUTPUT_DIGEST,
            output_digest,
