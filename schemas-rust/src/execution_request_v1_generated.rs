...
impl<'a> ExecutionRequestV1<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
    ...
    if let Some(x) = args.input_data { builder.add_input_data(x); }
  ...
  pub fn input_type(&self) -> ExecutionInputType {
    ...
    unsafe { self._tab.get::<ExecutionInputType>(ExecutionRequestV1::VT_INPUT_TYPE, Some(ExecutionInputType::URL)).unwrap()}
  }
  #[inline]
  pub fn tip(&self) -> u64 {
    // Safety:
  ...
  #[inline]
  pub fn execution_id(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(ExecutionRequestV1::VT_EXECUTION_ID, None)}
  }
  #[inline]
  pub fn image_id(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(ExecutionRequestV1::VT_IMAGE_ID, None)}
  }
  #[inline]
  ...
  pub fn input_data(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(ExecutionRequestV1::VT_INPUT_DATA, None)}
  }
}
...
impl flatbuffers::Verifiable for ExecutionRequestV1<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("execution_id", Self::VT_EXECUTION_ID, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("image_id", Self::VT_IMAGE_ID, false)?
     ...
     .visit_field::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'_, u8>>>("input_data", Self::VT_INPUT_DATA, false)?
     .finish();
    Ok(())
  }
}
pub struct ExecutionRequestV1Args<'a> {
    ...
    pub tip: u64,
    pub execution_id: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
    pub image_id: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, u8>>>,
...
impl<'a: 'b, 'b> ExecutionRequestV1Builder<'a, 'b> {
  ...
  pub fn add_input_type(&mut self, input_type: ExecutionInputType) {
    self.fbb_.push_slot::<ExecutionInputType>(ExecutionRequestV1::VT_INPUT_TYPE, input_type, ExecutionInputType::URL);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_execution_id(&mut self, execution_id: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ExecutionRequestV1::VT_EXECUTION_ID, execution_id);
  }
  #[inline]
  pub fn add_image_id(&mut self, image_id: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
  ...
  #[inline]
  pub fn add_input_data(&mut self, input_data: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ExecutionRequestV1::VT_INPUT_DATA, input_data);
  }
  #[inline]
